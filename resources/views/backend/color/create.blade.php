              ...
              @endif                
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9 div-upload">
                    <img src="{{ old('image_url') ? Helper::showImage(old('image_url')) : URL::asset('admin/dist/img/img.png') }}" id="thumbnail_image" class="img-thumbnail show_thumbnail" width="40" height="40">
