...
function openKCFinder_multipleFiles() {
    ...
    window.KCFinder.callBackMultiple = function(files) {
      ...
      window.open('{{ URL::asset("admin/dist/js/kcfinder/browse.php?type=images") }}', 'kcfinder_multiple','scrollbars=1,menubar=no,width='+ (w-300) +',height=' + (h-300) +',top=' + top+',left=' + left);
}
