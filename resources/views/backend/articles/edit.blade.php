...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('articles.update') }}" id="dataForm" class="productForm">
                ...
                <div>
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">                                                                        
                        ...
                        <div class="form-group">
                          <label>Liên hệ</label>                          
                          <textarea class="form-control" rows="4" name="contact" id="contact">{{ old('contact', $detail->contact) }}</textarea>
                        </div>
                        ...
                        <div class="form-group" style="margin-top: 15px !important;">
                          ...
                          <div class="clearfix"></div>
                          <textarea class="form-control" rows="4" name="position" id="position">{{ old('position', $detail->position) }}</textarea>
                        </div>
                        <div class="form-group" style="margin-top: 15px !important;">
                          ...
                          <div class="clearfix"></div>
                          <textarea class="form-control" rows="4" name="utilities" id="utilities">{{ old('utilities', $detail->utilities) }}</textarea>
                        </div>
                        <div class="form-group" style="margin-top: 15px !important;">
                          ...
                          <div class="clearfix"></div>
                          <textarea class="form-control" rows="4" name="ground" id="ground">{{ old('ground', $detail->ground) }}</textarea>
                        </div>                       
                        <div class="form-group" style="margin-top: 15px !important;">
                          <label>Tiến độ</label>
                          ...
                          <div class="clearfix"></div>
                          <textarea class="form-control" rows="4" name="process" id="process">{{ old('process', $detail->process) }}</textarea>
                        </div>
                              ...
                              @if( $detail->images->count() > 0 )
                                @foreach( $detail->images as $k => $hinh)
                                  <div class="col-md-3">
                                    ...
                                    <div class="checkbox">                                   
                                      <label><input type="radio" name="thumbnail_id" class="thumb" value="{{ $hinh->id }}" {{ $detail->thumbnail_id == $k ? "checked" : "" }}> Ảnh đại diện </label>
