                  ...
                  <tbody>
                    <tr>
                      ...
                      <h1 style="font-size:17px;font-weight:bold;color:#444;padding:0 0 5px 0;margin:0"> Cảm ơn
                          ...
                          đã đặt hàng tại LAHAVA,</h1>                    
                        <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"> LAHAVA rất vui thông báo đơn hàng #{{ $order_id }} của quý khách đã
                          được tiếp nhận và đang trong quá trình xử lý. LAHAVA sẽ thông báo đến quý khách
                          ngay khi hàng chuẩn bị được giao. </p>
                        <h3 style="font-size:13px;font-weight:bold;color:#000;text-transform:uppercase;margin:20px 0 0 0;border-bottom:1px solid #ddd"> Thông tin đơn hàng #{{ $order_id }} <span style="font-size:12px;color:#777;text-transform:none;font-weight:normal">(Ngày {{ date('d') }} Tháng {{ date('m') }} Năm {{ date('Y') }} {{ date('H:i:s') }})</span> </h3></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td><h2 style="text-align:left;margin:10px 0;border-bottom:1px solid #ddd;padding-bottom:5px;font-size:13px;color:#000"> CHI TIẾT ĐƠN HÀNG</h2>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#f5f5f5">
                          <thead>
                            <tr>
                              <th align="left" bgcolor="#000" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Sản phẩm</th>
                              <th align="left" bgcolor="#000" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Màu sắc</th>
                              <th align="left" bgcolor="#000" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Size</th>
                              <th align="left" bgcolor="#000" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px"> Đơn giá</th>
                              <th align="left" bgcolor="#000" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Số lượng</th>                             
                              <th align="right" bgcolor="#000" style="padding:6px 9px;color:#fff;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:14px">Tổng tạm</th>
                            </tr>
                          </thead>
                              ...
                              $product = $arrProductInfo[$product_id];
                                ...
                                <?php
                                  if(!in_array($key, $tl)){
                                    ...
                                    $price = $product->gia_thanh_ly;  
                                  }
                                ?>
                              <tr>
                              <td align="left" valign="top" style="padding:3px 9px"><span style="text-transform: uppercase;">{!! $product->name !!}</span><br>
                              <td align="left" valign="top" style="padding:3px 9px"><span>{{ ($colorArr[$tmp[1]]->name ) }}</span><br>
                              <td align="left" valign="top" style="padding:3px 9px"><span>{{ $sizeArr[$tmp[2]] }}</span><br>
                          ...
                          <tfoot style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px">
                            <tr>
                              <td colspan="5" align="right" style="padding:5px 9px">Tổng giá trị sản phẩm</td>
                            ...
                            <tr bgcolor="#eee">
                              <td colspan="5" align="right" style="padding:7px 9px"><strong><big>Tổng giá trị đơn hàng</big></strong></td>
