		...
		<div class="col-sm-9 col-xs-12 block-col-left">
			<div class="block-page-common block-sales">
				...
				<div class="block-content">
					...
					<div class="item">
						<div class="thumb">
							 <a href="{{ route('news-detail', ['slug' => $articles->slug, 'id' => $articles->id]) }}"><img title="{!! $articles->title !!}" src="{{ $articles->image_url ? Helper::showImage($articles->image_url) : URL::asset('assets/images/no-img.png') }}" alt="{!! $articles->title !!}"></a>
						</div>
						<div class="des">
