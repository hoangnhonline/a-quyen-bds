            ...
            <div class="box-body">
              ...
              <?php endif; ?>                
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="<?php echo e($detail->image_url ? Helper::showImage($detail->image_url ) : URL::asset('admin/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="85">
                ...
                <div class="form-group">
                  <label>Mô tả</label>                                    
                  <textarea class="form-control" rows="6" name="description" id="descriptions"><?php echo e($detail->description); ?></textarea>
                </div> 
